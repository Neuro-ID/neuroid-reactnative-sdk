		...
		<TouchableWithoutFeedback onPress={closeDropdowns}>
			<View style={[s.body, s.container, s.p3, styles.container]}>
				<View style={[styles.view, s.mt3]}>
					<Image source={require('./assets/images/nid-logo.png')} style={[s.mt5, s.mb5]} />
				</View>
				<ScrollView>
					...
					<SafeAreaView>
						...
						<View style={[s.mb3]}>
							<Text style={[s.text, styles.text, s.mb2]}>Employer Address:</Text>
							<TextInput
								style={[s.formControl]}
								autoCapitalize="none"
								autoCorrect={false}
						...
						<View style={[s.mb3]}>
							<Text style={[s.text, styles.text, s.mb2]}>Employer Phone Number:</Text>
							<TextInput
								style={[s.formControl]}
								autoCapitalize="none"
								autoCorrect={false}
						...
						<View style={[s.mb5, s.mt5]}>
							<TouchableHighlight
								style={[s.btnPrimary]}>
								<Button color="white" title="Agree and Check Your Loan Options" />
							</TouchableHighlight>
							<Text style={[s.text, styles.text, s.mb5]}>
								Checking your loan options does not affect your credit score.
							</Text>
